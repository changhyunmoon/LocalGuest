...
public record ScoringPolicySnapshot(
        ...
        int availabilityConsecutiveBoostPerDay,
        int availabilityConsecutiveBoostMax,
        int coldStartExplorationBonus,
        int coldStartMaxMatchRequestsWithoutReviews,
        int coldStartMaxChatStartsForExploration,
        int requiredLanguageMissPenalty,
        int niceToHaveLanguageWeightPercent,
        int strictBudgetMissPenalty,
        int recommendClickBonusPerCount,
        int recommendClickBonusMax,
        int recommendExposurePenaltyPerCount,
        int recommendExposurePenaltyMax,
    ...
    public static ScoringPolicySnapshot from(ScoringPolicySettings s) {
        ...
        return new ScoringPolicySnapshot(
                ...
                s.getAvailabilityConsecutiveBoostPerDay(),
                s.getAvailabilityConsecutiveBoostMax(),
                s.getColdStartExplorationBonus(),
                s.getColdStartMaxMatchRequestsWithoutReviews(),
                s.getColdStartMaxChatStartsForExploration(),
                s.getRequiredLanguageMissPenalty(),
                s.getNiceToHaveLanguageWeightPercent(),
                s.getStrictBudgetMissPenalty(),
                s.getRecommendClickBonusPerCount(),
                s.getRecommendClickBonusMax(),
                s.getRecommendExposurePenaltyPerCount(),
                s.getRecommendExposurePenaltyMax(),
