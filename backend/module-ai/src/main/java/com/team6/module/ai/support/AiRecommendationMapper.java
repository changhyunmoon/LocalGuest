...
public class AiRecommendationMapper {
    ...
    public static TravelerPreference toPreference(GuideRecommendRequest request) {
        ...
        return TravelerPreference.builder()
                ...
                .budgetMinWon(request.getBudgetMinWon())
                .budgetMaxWon(request.getBudgetMaxWon())
                .budgetScope(request.getBudgetScope())
                ...
                .excludedRegions(request.getExcludedRegions() == null ? List.of() : List.copyOf(request.getExcludedRegions()))
                .excludedTravelStyles(request.getExcludedTravelStyles() == null ? List.of() : List.copyOf(request.getExcludedTravelStyles()))
                .excludedLanguages(filterLangList(request.getExcludedLanguages()))
    ...
    public static List<GuideAiProfile> toGuideProfiles(
        ...
        return guideCandidates.stream()
                .map(candidate -> GuideAiProfile.builder()
                        ...
                        .priceMinWon(candidate.getPriceMinWon())
                        .priceMaxWon(candidate.getPriceMaxWon())
                        .priceScope(candidate.getPriceScope())
